...
def start_alarm() -> None:
    ...
    the alarm and adds each alarm to the schedular. This function runs
    on a separate thread each time the user loads the program.
    """
...
def alarm_end(alarm_time: datetime.datetime, alarm: dict, news_call: bool, weather_call: bool) -> None:
    ...
    If the user has checked news and weather checkboxes then news and
    weather information will be played. Covid Data News will be played on every alarm.
    """
