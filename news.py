...
def get_api_key() -> str:
    """Fetches the newsapi api key from the environment variable."""
    return os.environ.get('NEWSAPI_KEY', 'default_newsapi_key')


def get_news(tts_enabled: bool) -> None:
    """
    This function fetches the news data from newsapi using
    api key provided in the environment variable and stores the data in 
    "news.json".
